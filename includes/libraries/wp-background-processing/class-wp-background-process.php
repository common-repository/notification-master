...
namespace Notification_Master\Libraries\WP_Background_Processing;

use stdClass;
use Notification_Master\Libraries\WP_Background_Processing\WP_Async_Request;
...
abstract class WP_Background_Process extends WP_Async_Request {
	 ...
	 *
	 * @param bool|array $allowed_batch_data_classes Optional. Array of class Mozart_names that can be unserialized. Default true (any class).
	 */
	...
	public function get_batches( $limit = 0 ) {
		...
		$items = $wpdb->get_results( $wpdb->prepare( $sql, $args ) ); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared, WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Reason: Not possible to use prepare here and caching is not required.
	 ...
	 * @param bool|array $allowed_classes Array of class Mozart_names that can be unserialized.
	 *
	 * @return mixed
	 */
